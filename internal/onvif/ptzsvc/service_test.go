...
func (*mockProvider) GetNodes(_ context.Context) ([]PTZNode, error) {
	return []PTZNode{{Token: "node1", Name: "ePTZ"}}, nil
}
func (*mockProvider) GetNode(_ context.Context, token string) (PTZNode, error) {
	return PTZNode{Token: token, Name: "ePTZ"}, nil
}
func (*mockProvider) GetConfigurations(_ context.Context) ([]PTZConfiguration, error) {
	return []PTZConfiguration{{Token: "cfg1", Name: "ePTZ", NodeToken: "node1"}}, nil
}
func (*mockProvider) GetConfiguration(_ context.Context, token string) (PTZConfiguration, error) {
	return PTZConfiguration{Token: token, Name: "ePTZ", NodeToken: "node1"}, nil
}
func (*mockProvider) GetConfigurationOptions(
	_ context.Context, _ string,
) (ConfigurationOptions, error) {
	return ConfigurationOptions{
		PanTiltPositionSpaceRange: []SpaceRange{{
			URI:    "pos_space",
			XRange: IntRange{Min: -1, Max: 1},
			YRange: IntRange{Min: -1, Max: 1},
		}},
		ZoomPositionSpaceRange: []SpaceRange{{
			URI:    "pos_space",
			XRange: IntRange{Min: 0, Max: 1},
		}},
...
func (*mockProvider) ContinuousMove(
	_ context.Context, _ string, _ Speed, _ *string,
) error {
	return nil
}
func (*mockProvider) AbsoluteMove(
	_ context.Context, _ string, _ Vector, _ *Speed,
) error {
	return nil
}
func (*mockProvider) RelativeMove(
	_ context.Context, _ string, _ Vector, _ *Speed,
) error {
	return nil
}
func (*mockProvider) Stop(_ context.Context, _ string, _, _ *bool) error {
	return nil
}
func (m *mockProvider) GetPresets(_ context.Context, _ string) ([]Preset, error) {
	return m.presets, nil
}
func (*mockProvider) SetPreset(
	_ context.Context, _ string, name, token *string,
) (string, error) {
	t := "preset_1"
	if token != nil {
		t = *token
...
func (*mockProvider) RemovePreset(_ context.Context, _, _ string) error { return nil }
func (*mockProvider) GotoPreset(
	_ context.Context, _ string, _ string, _ *Speed,
) error {
	return nil
}
func (*mockProvider) GotoHomePosition(_ context.Context, _ string, _ *Speed) error {
	return nil
}
func (*mockProvider) SetHomePosition(_ context.Context, _ string) error { return nil }
...
func callPTZService(t *testing.T, h *Handler, body string) string {
	...
	req := httptest.NewRequestWithContext(ctx, http.MethodPost, PTZServicePath, strings.NewReader(body))
...
func TestGetNode(t *testing.T) {
	h := newHandler(t)
	resp := callPTZService(t, h, ptzSoapRequest("GetNode",
		`<tptz:NodeToken>node1</tptz:NodeToken>`))
...
func TestGetConfiguration(t *testing.T) {
	h := newHandler(t)
	resp := callPTZService(t, h, ptzSoapRequest("GetConfiguration",
		`<tptz:PTZConfigurationToken>cfg1</tptz:PTZConfigurationToken>`))
...
func TestGetConfigurationOptions(t *testing.T) {
	h := newHandler(t)
	resp := callPTZService(t, h, ptzSoapRequest("GetConfigurationOptions",
		`<tptz:ConfigurationToken>cfg1</tptz:ConfigurationToken>`))
...
func TestGetStatus(t *testing.T) {
	h := newHandler(t)
	resp := callPTZService(t, h, ptzSoapRequest("GetStatus",
...
func TestGetPresets(t *testing.T) {
	h := newHandler(t)
	resp := callPTZService(t, h, ptzSoapRequest("GetPresets",
		`<tptz:ProfileToken>main</tptz:ProfileToken>`))
...
func TestGotoHomePosition(t *testing.T) {
	h := newHandler(t)
	resp := callPTZService(t, h, ptzSoapRequest("GotoHomePosition",
		`<tptz:ProfileToken>main</tptz:ProfileToken>`))
...
func TestSetHomePosition(t *testing.T) {
	h := newHandler(t)
	resp := callPTZService(t, h, ptzSoapRequest("SetHomePosition",
		`<tptz:ProfileToken>main</tptz:ProfileToken>`))
...
func TestUnsupportedOperation(t *testing.T) {
	h := newHandler(t)
	ctx := context.Background()
	req := httptest.NewRequestWithContext(ctx, http.MethodPost, PTZServicePath,
		strings.NewReader(ptzSoapRequest("BogusOperation", "")))
	rec := httptest.NewRecorder()
	h.ServeHTTP(rec, req)
...
func TestMethodNotAllowed(t *testing.T) {
	h := newHandler(t)
	ctx := context.Background()
	req := httptest.NewRequestWithContext(ctx, http.MethodGet, PTZServicePath, http.NoBody)
	rec := httptest.NewRecorder()
	h.ServeHTTP(rec, req)
